...
export namespace todo {
  export class AddTodoRequest extends pb_1.Message {
    ...
    static fromObject(data: { title?: string }): AddTodoRequest {
  ...
  export class AddTodoResponse extends pb_1.Message {
    ...
    static fromObject(data: { id?: string }): AddTodoResponse {
  ...
  export class CompleteTodoRequest extends pb_1.Message {
    ...
    static fromObject(data: { id?: string }): CompleteTodoRequest {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CompleteTodoRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new CompleteTodoResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          default:
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new GetAllMyTodosRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          default:
  ...
  export class GetAllMyTodosResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.todos.length)
        writer.writeRepeatedMessage(1, this.todos, (item: Todo) =>
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new GetAllMyTodosResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.todos, () =>
  ...
  export class Todo extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.completed != false) writer.writeBool(3, this.completed);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class UpdateEmailRequest extends pb_1.Message {
    ...
    static fromObject(data: { email?: string }): UpdateEmailRequest {
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new UpdateEmailRequest();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
    ...
    static deserialize(
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new UpdateEmailResponse();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          default:
  ...
  export abstract class UnimplementedAuthenticationService {
    static definition = {
      Register: {
        ...
        requestSerialize: (message: RegisterRequest) =>
          Buffer.from(message.serialize()),
        requestDeserialize: (bytes: Buffer) =>
          RegisterRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message: RegisterResponse) =>
          Buffer.from(message.serialize()),
        responseDeserialize: (bytes: Buffer) =>
          RegisterResponse.deserialize(new Uint8Array(bytes)),
      },
      UpdateEmail: {
        path: '/todo.Authentication/UpdateEmail',
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: UpdateEmailRequest) =>
          Buffer.from(message.serialize()),
        requestDeserialize: (bytes: Buffer) =>
          UpdateEmailRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message: UpdateEmailResponse) =>
          Buffer.from(message.serialize()),
        responseDeserialize: (bytes: Buffer) =>
          UpdateEmailResponse.deserialize(new Uint8Array(bytes)),
      },
    };
    [method: string]: grpc_1.UntypedHandleCall;
    abstract Register(
      call: grpc_1.ServerUnaryCall<RegisterRequest, RegisterResponse>,
      callback: grpc_1.sendUnaryData<RegisterResponse>,
    ): void;
    abstract UpdateEmail(
      call: grpc_1.ServerUnaryCall<UpdateEmailRequest, UpdateEmailResponse>,
      callback: grpc_1.sendUnaryData<UpdateEmailResponse>,
    ): void;
  }
  export class AuthenticationClient extends grpc_1.makeGenericClientConstructor(
    UnimplementedAuthenticationService.definition,
    'Authentication',
    {},
  ) {
    constructor(
    ...
    Register: GrpcUnaryServiceInterface<RegisterRequest, RegisterResponse> = (
      message: RegisterRequest,
      metadata:
        | grpc_1.Metadata
        | grpc_1.CallOptions
        | grpc_1.requestCallback<RegisterResponse>,
      options?: grpc_1.CallOptions | grpc_1.requestCallback<RegisterResponse>,
      callback?: grpc_1.requestCallback<RegisterResponse>,
    ): grpc_1.ClientUnaryCall => {
      return super.Register(message, metadata, options, callback);
    };
    UpdateEmail: GrpcUnaryServiceInterface<
      UpdateEmailRequest,
      UpdateEmailResponse
    > = (
      ...
      metadata:
        | grpc_1.Metadata
        | grpc_1.CallOptions
        | grpc_1.requestCallback<UpdateEmailResponse>,
      options?:
        | grpc_1.CallOptions
        | grpc_1.requestCallback<UpdateEmailResponse>,
      callback?: grpc_1.requestCallback<UpdateEmailResponse>,
    ): grpc_1.ClientUnaryCall => {
  ...
  export abstract class UnimplementedTodoAppService {
    static definition = {
      AddTodo: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: AddTodoRequest) =>
          Buffer.from(message.serialize()),
        requestDeserialize: (bytes: Buffer) =>
          AddTodoRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message: AddTodoResponse) =>
          Buffer.from(message.serialize()),
        responseDeserialize: (bytes: Buffer) =>
          AddTodoResponse.deserialize(new Uint8Array(bytes)),
      },
      CompleteTodo: {
        path: '/todo.TodoApp/CompleteTodo',
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: CompleteTodoRequest) =>
          Buffer.from(message.serialize()),
        requestDeserialize: (bytes: Buffer) =>
          CompleteTodoRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message: CompleteTodoResponse) =>
          Buffer.from(message.serialize()),
        responseDeserialize: (bytes: Buffer) =>
          CompleteTodoResponse.deserialize(new Uint8Array(bytes)),
      },
      GetAllMyTodos: {
        path: '/todo.TodoApp/GetAllMyTodos',
        requestStream: false,
        responseStream: false,
        requestSerialize: (message: GetAllMyTodosRequest) =>
          Buffer.from(message.serialize()),
        requestDeserialize: (bytes: Buffer) =>
          GetAllMyTodosRequest.deserialize(new Uint8Array(bytes)),
        responseSerialize: (message: GetAllMyTodosResponse) =>
          Buffer.from(message.serialize()),
        responseDeserialize: (bytes: Buffer) =>
          GetAllMyTodosResponse.deserialize(new Uint8Array(bytes)),
      },
    };
    [method: string]: grpc_1.UntypedHandleCall;
    abstract AddTodo(
      call: grpc_1.ServerUnaryCall<AddTodoRequest, AddTodoResponse>,
      callback: grpc_1.sendUnaryData<AddTodoResponse>,
    ): void;
    abstract CompleteTodo(
      call: grpc_1.ServerUnaryCall<CompleteTodoRequest, CompleteTodoResponse>,
      callback: grpc_1.sendUnaryData<CompleteTodoResponse>,
    ): void;
    abstract GetAllMyTodos(
      call: grpc_1.ServerUnaryCall<GetAllMyTodosRequest, GetAllMyTodosResponse>,
      callback: grpc_1.sendUnaryData<GetAllMyTodosResponse>,
    ): void;
  }
  export class TodoAppClient extends grpc_1.makeGenericClientConstructor(
    UnimplementedTodoAppService.definition,
    'TodoApp',
    {},
  ) {
    constructor(
    ...
    AddTodo: GrpcUnaryServiceInterface<AddTodoRequest, AddTodoResponse> = (
      message: AddTodoRequest,
      metadata:
        | grpc_1.Metadata
        | grpc_1.CallOptions
        | grpc_1.requestCallback<AddTodoResponse>,
      options?: grpc_1.CallOptions | grpc_1.requestCallback<AddTodoResponse>,
      callback?: grpc_1.requestCallback<AddTodoResponse>,
    ): grpc_1.ClientUnaryCall => {
      return super.AddTodo(message, metadata, options, callback);
    };
    CompleteTodo: GrpcUnaryServiceInterface<
      CompleteTodoRequest,
      CompleteTodoResponse
    > = (
      ...
      metadata:
        | grpc_1.Metadata
        | grpc_1.CallOptions
        | grpc_1.requestCallback<CompleteTodoResponse>,
      options?:
        | grpc_1.CallOptions
        | grpc_1.requestCallback<CompleteTodoResponse>,
      callback?: grpc_1.requestCallback<CompleteTodoResponse>,
    ): grpc_1.ClientUnaryCall => {
      return super.CompleteTodo(message, metadata, options, callback);
    };
    GetAllMyTodos: GrpcUnaryServiceInterface<
      GetAllMyTodosRequest,
      GetAllMyTodosResponse
    > = (
      ...
      metadata:
        | grpc_1.Metadata
        | grpc_1.CallOptions
        | grpc_1.requestCallback<GetAllMyTodosResponse>,
      options?:
        | grpc_1.CallOptions
        | grpc_1.requestCallback<GetAllMyTodosResponse>,
      callback?: grpc_1.requestCallback<GetAllMyTodosResponse>,
    ): grpc_1.ClientUnaryCall => {
